        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link href="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-indigo-600 dark:text-indigo-400">AgriConnect</span>
            </Link>
            <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link
                href="/admin/general-storage"
                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${
                  pathname === "/admin/general-storage"
                    ? "border-indigo-500 text-gray-900 dark:text-white"
                    : "border-transparent text-gray-500 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700 hover:text-gray-700 dark:hover:text-gray-200"
                }`}
              >
